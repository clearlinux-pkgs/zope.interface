...
Source0  : https://files.pythonhosted.org/packages/f8/44/8531e65de6fde76e6055f5ce93e8a482dff534cea9bebcac7845e2273efd/zope.interface-4.7.2.tar.gz
...
%prep
%setup -q -n zope.interface-4.7.2
cd %{_builddir}/zope.interface-4.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583876176
...
cp %{_builddir}/zope.interface-4.7.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/zope.interface/a0b53f43aab58b46bf79ba756c50771c605ab4c5
