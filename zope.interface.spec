...
%prep
%setup -q -n zope.interface-5.1.0
cd %{_builddir}/zope.interface-5.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586359734
...
cp %{_builddir}/zope.interface-5.1.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/zope.interface/a0b53f43aab58b46bf79ba756c50771c605ab4c5
