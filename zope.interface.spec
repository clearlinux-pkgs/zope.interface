...
Version  : 5.3.0
Release  : 69
URL      : https://files.pythonhosted.org/packages/b1/f8/aa59109d5345ece4820e8e7a05a97203ef21a0ac2c0460c6c929ea5be889/zope.interface-5.3.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/b1/f8/aa59109d5345ece4820e8e7a05a97203ef21a0ac2c0460c6c929ea5be889/zope.interface-5.3.0.tar.gz
...
%prep
%setup -q -n zope.interface-5.3.0
cd %{_builddir}/zope.interface-5.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616433901
...
cp %{_builddir}/zope.interface-5.3.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/zope.interface/a0b53f43aab58b46bf79ba756c50771c605ab4c5
