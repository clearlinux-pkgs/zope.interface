...
Version  : 5.0.0
Release  : 56
URL      : https://files.pythonhosted.org/packages/4e/a2/0c1e3441940174a6b920e029376621ae656770d9221495910ab9b569eec9/zope.interface-5.0.0.tar.gz
...
%prep
%setup -q -n zope.interface-5.0.0
cd %{_builddir}/zope.interface-5.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584719662
...
cp %{_builddir}/zope.interface-5.0.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/zope.interface/a0b53f43aab58b46bf79ba756c50771c605ab4c5
