...
Source0  : https://files.pythonhosted.org/packages/84/21/80cdc749908ebf2719a9063eddcc02b668fbc62d200c1f1a4d92aaaba76b/zope.interface-5.2.0.tar.gz
...
%prep
%setup -q -n zope.interface-5.2.0
cd %{_builddir}/zope.interface-5.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604632765
...
cp %{_builddir}/zope.interface-5.2.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/zope.interface/a0b53f43aab58b46bf79ba756c50771c605ab4c5
