...
Source0  : https://files.pythonhosted.org/packages/e5/4f/86e90a34419df9c32a6e88b06f18233cffe93a236f7d2690f707c816fbe6/zope.interface-5.1.2.tar.gz
...
%prep
%setup -q -n zope.interface-5.1.2
cd %{_builddir}/zope.interface-5.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601570974
...
cp %{_builddir}/zope.interface-5.1.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/zope.interface/a0b53f43aab58b46bf79ba756c50771c605ab4c5
